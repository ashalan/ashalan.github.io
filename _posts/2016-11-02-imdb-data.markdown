...
<p>
  ...
  <span>The DecisionTreeClassifier Best Score was  <pre>0.850</pre> which is not better than before (0.863).</span>
  <span>The BaggingClassifier Best Score was  <pre>0.935</pre> which is the best we've seen yet.</span>
</p>
